        ...
        while (opModeIsActive() && (running)) {
            switch(runState){
                ...
                case LOW_JUNCTION_2:
                    ...
                    //drive.PIDRotate(-90, robot.PID_ROTATE_ERROR);
                    drive.driveDistance(0.5,180,23);
                ...
                case PARK:
                    ...
                    if(position == 3) {
                        ...
                        // drive to park position 1
                        drive.driveDistance(0.8, 180,25);
                    }
